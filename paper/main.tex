...
Deliverable 1 \ \textbullet\ \ Generative Artificial Intelligence (580694) \ \textbullet\ \ Universidad de Concepci\'on}\\[1.4mm]
{\footnotesize\color{white!85}Equipo:} \ph{Pedro Dañobeytia \textbullet\ Rafael Fernández \textbullet\ Cristian Gonzalez \textbullet\ Daniel Gonzalez}
\hfill
{\footnotesize\color{white!85}Repositorio:} \ph{github.com/Rafaefe/AIBattlesInPokemon}
\end{tcolorbox}
...
\end{itemize}
Qwen2.5-1.5B es adem\'as la l\'inea base: el \'unico con un perfil \emph{medido} aqu\'i. La tarea no exige de forma evidente un modelo de 8B, lo que motiva evaluar candidatos bastante m\'as peque\~nos.
